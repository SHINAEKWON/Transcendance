                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-center gap-10 flex-wrap">
                            <label class="cursor-pointer transform hover:scale-110 transition">
                                ...
                                <img src="./public/images/avatar1.png" alt="Avatar 1" class="w-32 h-32 rounded-full border-4 border-transparent hover:border-neon-purple transition" />
                            </label>
                            <label class="cursor-pointer transform hover:scale-110 transition">
                                <input type="radio" name="avatar" value="avatar2" class="hidden" />
                                <img src="./public/images/avatar2.png" alt="Avatar 2" class="w-32 h-32 rounded-full border-4 border-transparent hover:border-neon-orange transition" />
                            </label>
                            <label class="cursor-pointer transform hover:scale-110 transition">
                                <input type="radio" name="avatar" value="avatar3" class="hidden" />
                                <img src="./public/images/avatar3.png" alt="Avatar 3" class="w-32 h-32 rounded-full border-4 border-transparent hover:border-neon-blue transition" />
                            </label>
                        </div>
                    </div>
