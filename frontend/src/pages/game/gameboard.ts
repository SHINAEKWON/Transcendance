...
function endGame(): void
{
    ...
    {
        // 🔄 Mise à jour du hash pour naviguer vers la page revanche
        window.location.hash = `#revanche?player1=${encodeURIComponent(name_left.textContent || "")}&player2=${encodeURIComponent(name_right.textContent || "")}&winner=${won}`;
    }
}
