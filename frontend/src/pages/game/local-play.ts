            ...
            <div class="max-w-5xl mx-auto bg-gray-800 p-8 rounded-lg shadow-lg text-center">
                ...
                <div class="flex justify-between items-center max-w-3xl mx-auto mb-6">
                    ...
                    <div class="w-1/3 text-center">
                        ...
                        <input id="player1" type="text" placeholder="Enter name..." class="w-full p-2 rounded bg-gray-700 text-white text-center">
                    </div>
                    ...
                    <div class="w-1/3 text-center">
                        ...
                        <input id="player2" type="text" placeholder="Enter name..." class="w-full p-2 rounded bg-gray-700 text-white text-center">
                    </div>
                </div>
