        ...
        return `
            <div class="max-w-4xl mx-auto bg-gray-800 p-6 rounded-lg shadow-lg">
                ...
                <div class="bg-gray-900 p-4 rounded-lg h-96 overflow-y-auto mb-4">
                    <div class="space-y-4">
                        <div class="flex items-start space-x-3">
                            <img src="https://api.dicebear.com/7.x/pixel-art/svg?seed=player1" class="w-8 h-8 rounded">
                        ...
                        <div class="flex items-start space-x-3">
                            <img src="https://api.dicebear.com/7.x/pixel-art/svg?seed=player2" class="w-8 h-8 rounded">
                            <div class="bg-gray-800 p-3 rounded-lg">
                ...
                <div class="flex space-x-2">
                    <input type="text" class="flex-1 bg-gray-700 text-white p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-neon-blue" placeholder="Type your message...">
