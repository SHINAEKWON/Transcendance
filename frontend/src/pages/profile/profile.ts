...
export class ProfilePage implements Page {
    async render() {
        ...
        const winRate = userToDisplay.matches > 0 ? ((userToDisplay.wins / userToDisplay.matches) * 100).toFixed(1) : "0";
        ...
        const html = `
            <div class="max-w-5xl mx-auto bg-gray-800 p-8 rounded-2xl shadow-xl">
                ...
                <div class="mb-10">
                    ...
                    <p class="text-xl text-white font-bold">Lv. ${userToDisplay.level}</p>
                </div>
                ...
                <div class="mt-2">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                        <div class="bg-gray-700 p-4 rounded-lg">
                            ...
                            <p class="text-2xl text-white font-bold">${userToDisplay.matches}</p>
                        </div>
                        <div class="bg-gray-700 p-4 rounded-lg">
                            <p class="text-sm text-gray-300">${t('wins')}</p>
                            <p class="text-2xl text-green-400 font-bold">${userToDisplay.wins}</p>
                        </div>
                        <div class="bg-gray-700 p-4 rounded-lg">
                            <p class="text-sm text-gray-300">${t('losses')}</p>
                            <p class="text-2xl text-red-400 font-bold">${userToDisplay.losses}</p>
                        </div>
                        <div class="bg-gray-700 p-4 rounded-lg">
